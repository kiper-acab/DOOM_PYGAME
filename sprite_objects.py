...
class Sprites:
    def __init__(self):
        # Определение параметров спрайтов
        self.sprite_parameters = {
         ...
         # Определение списка объектов с использованием параметров спрайтов
        self.list_of_objects = [
            SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 2.1)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 2.1)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (7.1, 5.0)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 5.0)),
            ...
            SpriteObject(self.sprite_parameters['npc_soldier0'], (2.32, 2.55)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (3.26, 4.29)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (3.26, 5.23)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (3.26, 6.29)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (3.26, 5.29)),
        ]

    # Возвращает координаты ближайшего спрайта, находящегося под огнем
    @property
...
class SpriteObject:
    # Инициализация объекта спрайта с использованием переданных параметров и позиции
    ...
    # Проверяет, находится ли спрайт под огнем
    @property
    def is_on_fire(self):
    ...
    # Определение расположения спрайта относительно игрока
    ...
    # Определение анимации при смерти спрайта
